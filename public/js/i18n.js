...
const DICT = {
  'zh-TW': {
    ...
    character: '角色', artStyle: '畫風', styleHd: '真人 HD', styleChibi: 'Q 版', stylePixel: '像素版',
    ...
    newSession: '開始新對話', newSessionConfirm: '要開始新對話嗎？之後的訊息將不再參考先前的對話內容，但聊天紀錄仍會保留在畫面上。',
    ...
    needDecayHint: '00:00–10:00 為休息時間；醒著時若需求長時間未被照顧，親密度會慢慢下降。',
  ...
  en: {
    ...
    character: 'Character', artStyle: 'Art style', styleHd: 'Photoreal', styleChibi: 'Chibi', stylePixel: 'Pixel',
    ...
    newSession: 'Start new session', newSessionConfirm: 'Start a new session? New messages will no longer use earlier chat as context, but your chat history stays visible.',
    ...
    needDecayHint: 'Quiet hours are 00:00–10:00. Unmet needs slowly reduce the bond while awake.',
