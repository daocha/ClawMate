...
const DICT = {
  'zh-TW': {
    appName: 'ClawMate 伴靈',
    tabPet: '伴靈', tabChat: '聊天', tabNotes: '便利貼', tabSettings: '設定',
    notesTitle: '便利貼', notesHint: '想到的小事，先幫你記在這裡。', notesSearch: '搜尋便利貼……', notesEmpty: '還沒有便利貼。\n想到什麼就先記下來吧。', selectNotes: '選取', selectedNotes: '已選 {count} 張', deleteSelected: '刪除選取', deleteSelectedConfirm: '要刪除選取的 {count} 張便利貼嗎？', schedulesTitle: '提醒日程', schedulesEmpty: '目前沒有待提醒的便利貼。', scheduleCount: '{count} 項', editSchedule: '修改提醒', scheduleTime: '提醒時間', scheduleRepeat: '重複方式', scheduleOnce: '只提醒一次', scheduleYearly: '每年重複', saveSchedule: '儲存提醒', scheduleSaved: '提醒已更新', scheduleSaveFail: '儲存提醒失敗', expiredNotesTitle: '待刪除', expiredNotesHint: '已超過保留期限；它們不會自動刪除。', deleteExpired: '刪除已過期', deleteExpiredConfirm: '要刪除所有已過期的便利貼嗎？',
    addNote: '新增便利貼', newNote: '新增便利貼', editNote: '編輯便利貼', noteDetail: '便利貼', editNoteHint: '點內容即可編輯', notePlaceholder: '寫下一件想記住的小事……', saveNote: '儲存', deleteNote: '刪除', deleteNoteConfirm: '要刪除這張便利貼嗎？', pinNote: '釘選', unpinNote: '取消釘選', noteSaved: '已收進便利貼', noteDeleted: '便利貼已刪除', notesLoadFail: '讀取便利貼失敗', notesSaveFail: '儲存便利貼失敗', noteExpiresOn: '待刪除：{date}', noteKeptForever: '永久保留', noteReminderOnce: '提醒：{date}', noteReminderYearly: '每年提醒：{date}',
    ...
    pushTest: '測試關閉 PWA 後的通知', pushTestQueued: '5 秒後送出，請立刻關閉 PWA', pushTestFailed: '測試通知失敗', pushTestNoSubscription: '沒有有效的推播訂閱',
    ...
    dndHours: '請勿打擾時段', noteExpiryDays: '便利貼預設保留天數', noteExpiryDaysHelp: '新增便利貼後幾天歸到「待刪除」。不會自動刪除。',
  ...
  en: {
    appName: 'ClawMate',
    tabPet: 'Mate', tabChat: 'Chat', tabNotes: 'Notes', tabSettings: 'Settings',
    notesTitle: 'Sticky notes', notesHint: 'Keep the little things you want to remember.', notesSearch: 'Search notes…', notesEmpty: 'No notes yet.\nSave a little thing when it comes to mind.', selectNotes: 'Select', selectedNotes: '{count} selected', deleteSelected: 'Delete selected', deleteSelectedConfirm: 'Delete the {count} selected sticky notes?', schedulesTitle: 'Reminder schedule', schedulesEmpty: 'No upcoming note reminders.', scheduleCount: '{count}', editSchedule: 'Edit reminder', scheduleTime: 'Reminder time', scheduleRepeat: 'Repeat', scheduleOnce: 'One time', scheduleYearly: 'Every year', saveSchedule: 'Save reminder', scheduleSaved: 'Reminder updated', scheduleSaveFail: "Couldn't save reminder", expiredNotesTitle: 'Pending deletion', expiredNotesHint: 'These passed their retention date and will never delete themselves.', deleteExpired: 'Delete expired', deleteExpiredConfirm: 'Delete every expired sticky note?',
    addNote: 'Add note', newNote: 'New note', editNote: 'Edit note', noteDetail: 'Sticky note', editNoteHint: 'Tap the note to edit', notePlaceholder: 'Write down a little thing to remember…', saveNote: 'Save', deleteNote: 'Delete', deleteNoteConfirm: 'Delete this sticky note?', pinNote: 'Pin', unpinNote: 'Unpin', noteSaved: 'Saved to notes', noteDeleted: 'Note deleted', notesLoadFail: "Couldn't load notes", notesSaveFail: "Couldn't save note", noteExpiresOn: 'Pending deletion: {date}', noteKeptForever: 'Kept permanently', noteReminderOnce: 'Reminder: {date}', noteReminderYearly: 'Yearly reminder: {date}',
    ...
    pushTest: 'Test notification after closing PWA', pushTestQueued: 'Sending in 5 seconds — close the PWA now', pushTestFailed: 'Test notification failed', pushTestNoSubscription: 'No active push subscription',
    ...
    dndHours: 'Do-not-disturb hours', noteExpiryDays: 'Default note retention (days)', noteExpiryDaysHelp: 'New notes move to Pending deletion after this many days. They never delete automatically.',
